...
>
	...
	<div id="content-head">
		...
		<p>Généré par <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank">All in One SEO</a>, Ceci est un plan du site en XML, dans le but d'être lu par des moteurs de recherche tels que Google ou Bing.</p>
		<p>
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on 31 mars 2023 at 4h12			</p>
		</xsl:if>
	</div>
</xsl:template>
